...
public class PostController {
    ...
    //The final page after login which shows the information.(Get Mapping)
    @RequestMapping("/dash")
    private String dash(
            Model model,
            HttpSession session
    ...
    //Post Mapping in the dash endpoint, as it has a form to be filled and submitted again
    ...
    //Delete mapping for each individual post.
